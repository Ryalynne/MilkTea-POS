                                ...
                                <tr class="bg-white border-b tr">
                                    ...
                                    <td class="border px-6 py-4">
                                        <a href="#"
                                            ...
                                            data-id="{{ $item->id }}" data-name="{{ $item->unit_name }}">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 max-h-[800px] overflow-y-auto">
                ...
                <form method="POST" action="{{ route('Insert-unit') }}">
                    ...
                    <div class="flex items-center justify-between w-full">
                        <h3 class="text-lg font-bold leading-6 text-gray-900 mb-2">--------- REGISTER UNIT
                            ------------</h3>
                    ...
                    <div class="mb-6">
                        <label for="text" class="block mb-2 text-sm font-medium text-gray-900">UNIT OF MEASURMENT
                            NAME</label>
                        <input name="unit_name" type="text" id="text"
        ...
        <div id="myModal1"
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 max-h-[800px] overflow-y-auto">
                ...
                <form method="POST" action="{{ route('Update-Categories') }}">
                    @csrf
                    <div class="flex items-center justify-between w-full">
                        <h3 class="text-lg font-bold leading-6 text-gray-900 mb-2">--------- UPDATE UNIT
                            ------------</h3>
                    ...
                    <button type="submit" name="unitBTN"
