<x-app-layout>
                                ...
                                <tr class="bg-white border-b tr">
                                    ...
                                    <td class="border px-6 py-4">
                                        <a href="#"
                                            ...
                                            data-id="{{ $item->id }}" data-name="{{ $item->recipe->recipe_name }}"
                                            data-status="{{ $item->addOn }}">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
        ...
        <div id="myModal1"
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 max-h-[800px] overflow-y-auto">
                ...
                <form method="POST" action="{{ route('Update-Categories') }}">
                    ...
                    <div class="mb-6">
                        <label for="text" class="block mb-2 text-sm font-medium text-gray-900">TOPPINGS
                            NAME</label>
                    ...
                    <button type="submit" name="toppingBTN"
    ...
    <script src="{{ asset('./javascript/update_topping.js') }}"></script>
