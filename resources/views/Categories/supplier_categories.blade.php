<x-app-layout>
    ...
    <div id="myModal" class="hidden fixed inset-0 z-10 bg-gray-500 bg-opacity-75 flex justify-center items-center">
        <div class="bg-white rounded-lg shadow-lg p-8 max-h-[800px] overflow-y-auto">
            ...
            <form method="POST" action="{{ route('Insert-supcategories') }}">
                @csrf
                <div class="flex items-center justify-between w-full">
                    <h3 class="text-lg font-bold leading-6 text-gray-900 mb-2">--------- REGISTER SUPPLIER
                        ------------</h3>
                ...
                <div class="mb-6">
                    ...
                    <input name="supplier_name" type="text" id="text"
