                ...
                <div class="flex mt-3">
                    ...
                    <div class="relative">
                        <div
                            ...
                            <svg class="w-4 h-4 text-gray-500 mb-2" aria-hidden="true"
                        ...
                        <input type="text" id="table-search-users"
                            class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <tbody>
                            @foreach ($productItem as $product)
                                <tr>
                                    ...
                                    <td>{{ $product->Product_Cetegories }}</td>
                                    <td>{{ $product->Product_Cetegories }}</td>
                                    <td>{{ $product->Product_Cetegories }}</td>
        ...
        <div id="myModal"
            ...
            <div class="bg-white rounded-lg shadow-lg p-8"> <!-- Increased padding -->
                <form method="POST" action="{{ route('Insert-Product') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        <label for="text" class="block mb-2 text-sm font-medium text-gray-900">UPLOAD IMAGE</label>
                        <input name="Image"
                    ...
                    <div class="mb-6">
                        ...
                        <select name="Product_Cetegories" id="countries"
                            ...
                            <option value="1">CREAM CHEESE SERIES MILKTEA</option>
