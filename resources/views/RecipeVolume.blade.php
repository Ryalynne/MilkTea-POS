<x-app-layout>
                    ...
                    Volume Deduct
                        ...
                        <tbody>
                            @foreach ($item as $items)
                                <tr
                                    class="{{ $items->reorder_lvl > $items->remaining ? 'bg-red-200' : 'bg-white' }} border-b tr">
                                    <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap">
                                        {{ $items->recipe->recipe_name }}
                                    </th>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ $items->supplier->supplier_name }}
                                    </td>
                                    <td class="border px-6 py-4">
                                        <a href="#"
                                            class="modalButtonUpdate font-medium text-blue-600 hover:underline edit-link"
                                            data-id="{{ $items->id }}"
                                            data-recipe_name="{{ $items->recipe->recipe_name }}"
                                            data-brand_name="{{ $items->brand_id }}"
                                            data-supplier_name="{{ $items->supplier_id }}"
                                            data-unit_name="{{ $items->unit_id }}" data-volume="{{ $items->volume }}"
                                            data-price="{{ $items->price }}"
                                            data-reorder_lvl="{{ $items->reorder_lvl }}"
                                            data-pick_up_or_delivery="{{ $items->pick_up_or_delivery }}"
                                            data-remaining="{{ $items->remaining }}"
                                            data-contact_number="{{ $items->contact_number }}"
                                            data-contact_person="{{ $items->contact_person }}">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
    ...
    <div id="myModal1" class="hidden fixed inset-0 z-10 bg-gray-500 bg-opacity-75 flex justify-center items-center">
        <div class="bg-white rounded-lg shadow-lg p-8 max-h-[800px] overflow-y-auto">
            ...
            <form method="POST" action="{{ route('Update-Volume') }}">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <select disabled name="brand_id" id="brand1"
                        class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-white">
                        {{-- <option selected value="">-- Choose Brand --</option> --}}
                ...
                <div class="mb-6">
                    ...
                    <select disabled name="supplier_id" id="supplier1"
                        class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-white">
                ...
                <div class="mb-6">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900">UNIT
                        MEASUREMENT</label>
                    <select disabled name="unit_id" id="unit1"
                        class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-white">
                ...
                <div class="mb-6">
                    ...
                    <input name="reorder_lvl" type="number" id="Reoder_Level1"
                        ...
                        placeholder="Enter Reoder Level" disabled />
                </div>
                <div class="mb-6">
                    ...
                    <input name="volume" type="number" id="volume1"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Enter volume" disabled />
                ...
                <div class="mb-6">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900">VOLUME TO</label>
                    <input name="volume_to" type="text" id="volume_to"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Enter Number of Volume" required />
                </div>
